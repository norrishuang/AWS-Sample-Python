...
DATABASE="tpcds_small_files_hash"
ENABLE_HASH="true"
FILESIZE="1048576"
...
SPARK_SUBMIT_PARAMETERS="--conf spark.hadoop.hive.metastore.client.factory.class=com.amazonaws.glue.catalog.metastore.AWSGlueDataCatalogHiveClientFactory --conf spark.sql.catalog.s3tablesbucket=org.apache.iceberg.spark.SparkCatalog --conf spark.sql.catalog.s3tablesbucket.catalog-impl=software.amazon.s3tables.iceberg.S3TablesCatalog --conf spark.sql.catalog.s3tablesbucket.warehouse=arn:aws:s3tables:us-east-1:812046859005:bucket/iceberg-data-812046859005 --packages org.apache.iceberg:iceberg-spark-runtime-3.5_2.12:1.6.1,software.amazon.s3tables:s3-tables-catalog-for-iceberg-runtime:0.1.3 --conf spark.executor.cores=4 --conf spark.executor.memory=16g --conf spark.driver.cores=4 --conf spark.driver.memory=16g --conf spark.driver.maxResultSize=4g --conf spark.emr-serverless.driver.disk=50G --conf spark.emr-serverless.executor.disk=50G --conf spark.network.retry.count=5 --conf spark.network.retry.wait=5s --conf spark.dynamicAllocation.enabled=true --conf spark.dynamicAllocation.initialExecutors=1 --conf spark.dynamicAllocation.maxExecutors=80 --conf spark.dynamicAllocation.minExecutors=1"
