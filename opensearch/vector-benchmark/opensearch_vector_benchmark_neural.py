#!/usr/bin/env python3
"""
OpenSearch Vector Benchmark Data Generator with Neural Sparse Vector Support
...
(sparse vector with neural sparse format).
"""
...
INDEX_NAME = 'vector_benchmark_neural'
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Generate and index random data into OpenSearch with neural sparse vector support')
