...
config = {
    "table_name": "hudi_portfolio_mor_kc",
    "database_name": "hudi",
    "target": "s3://myemr-bucket-01/data/hudi/hudi_portfolio_mor_kc",
    "primary_key": "id",
    "sort_key": "id",
    "commits_to_retain": "4",
...
def processBatch(data_frame, batchId):
    if (data_frame.count() > 0):
        ...
        # dataUpsert = data_frame.filter(((col("op") == "c") | (col("op") == "r") | (col("op") == "u")) & col("after").isNotNull) \
